...
contract PAGS is ERC20, Ownable {
    ...
    address public _marketingWallet = 0xE371f8A20205Ca9F69B0134902E4F8C7F5D919b8;
    ...
    constructor() ERC20("Phat Ass Token", "PAT") {
        ...
        */
        _mint(owner(), 6942069 * (10**9));
    }

    receive() external payable {}

    function updateFees(uint256 newRewardFee, uint256 newLiqFee, uint256 newMarketingFee) public onlyOwner {
